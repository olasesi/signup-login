  ...
  <!--theme-switch-wrapper-->
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Email address is required">
						...
						<input class="input100" type="text" name="emailaddress" placeholder="Type your Email address">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
                    
                    <div class="wrap-input100 validate-input m-b-23" data-validate = "Password is required">
						<span class="label-input100">Password</span>
						<input class="input100" type="password" name="password" placeholder="Type your password" id="pass" onkeyup="CheckPasswordStrength(this.value)">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
                       
					</div>
<div>
<label>Password Strength: </label> <strong id="password_strength"></strong>
                       <br><span id="show"></span><br>
</div>

                    <div class="wrap-input100 validate-input m-b-23" data-validate = "Confirm password is required">
						<span class="label-input100">Confirm password</span>
						<input class="input100" type="password" name="confirmpassword" placeholder="Confirm your password">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
...
<!--===============================================================================================-->
    ...
    <script src="js/password-strenght.js"></script>
